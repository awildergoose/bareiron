...
void getCraftingOutput(PlayerData *player, uint8_t *count, uint16_t *item) {
    ...
    case I_snow_block:
      ...
      if (first_col == 0 && player->craft_items[first + 1] == first_item &&
        ...
        if (first_item == I_oak_planks)
          *item = I_oak_slab;
        else if (first_item == I_cobblestone)
          *item = I_cobblestone_slab;
        else if (first_item == I_stone)
          *item = I_stone_slab;
        else if (first_item == I_snow_block)
          *item = I_snow;
        *count = 6;
        return;
      }
    ...
    case I_netherite_ingot:
      ...
      if (first_row == 0 && player->craft_items[first + 3] == I_stick &&
        ...
        if (first_item == I_oak_planks)
          ...
          *item = I_stone_shovel;
        else if (first_item == I_iron_ingot)
          *item = I_iron_shovel;
        else if (first_item == I_gold_ingot)
          *item = I_golden_shovel;
        else if (first_item == I_diamond)
          *item = I_diamond_shovel;
        else if (first_item == I_netherite_ingot)
  ...
  case 4:
    ...
    case I_snowball:
      ...
      if (first_col != 2 && first_row != 2 &&
        ...
        if (first_item == I_oak_planks) {
          ...
          *count = 1;
        } else if (first_item == I_oak_log) {
          *item = I_oak_wood;
          *count = 3;
        } else if (first_item == I_snowball) {
          *item = I_snow_block;
          *count = 3;
        }
        return;
    ...
    case I_netherite_ingot:
      if (first_col == 0 && first_row < 2 &&
        ...
        if (first_item == I_leather)
          *item = I_leather_boots;
        else if (first_item == I_iron_ingot)
          *item = I_iron_boots;
        else if (first_item == I_gold_ingot)
          *item = I_golden_boots;
        else if (first_item == I_diamond)
          *item = I_diamond_boots;
        else if (first_item == I_netherite_ingot)
          *item = I_netherite_boots;
        *count = 1;
        return;
      }
      break;
  ...
  case 5:
    ...
    case I_netherite_ingot:
      // Pickaxe recipes
      if (first == 0 && player->craft_items[first + 1] == first_item &&
          player->craft_items[first + 2] == first_item &&
    ...
    case I_leather:
      ...
      if (first_col == 0 && first_row < 2 &&
          ...
          player->craft_items[first + 5] == first_item) {
        if (first_item == I_leather)
          *item = I_leather_helmet;
        else if (first_item == I_iron_ingot)
          *item = I_iron_helmet;
        else if (first_item == I_gold_ingot)
          *item = I_golden_helmet;
        else if (first_item == I_diamond)
          *item = I_diamond_helmet;
        else if (first_item == I_netherite_ingot)
          *item = I_netherite_helmet;
        *count = 1;
        return;
      }
      break;
  ...
  case 7:
    ...
    if (identical && player->craft_items[4] == 0 &&
      ...
      case I_leather:
        ...
        *count = 1;
        return;
      case I_iron_ingot:
        *item = I_iron_leggings;
        *count = 1;
        return;
      case I_gold_ingot:
        *item = I_golden_leggings;
        *count = 1;
        return;
      case I_diamond:
        *item = I_diamond_leggings;
        *count = 1;
        return;
      case I_netherite_ingot:
        *item = I_netherite_leggings;
        *count = 1;
        return;
      default:
        break;
    ...
    switch (first_item) {
    case I_oak_slab:
      if (identical && player->craft_items[1] == 0 &&
  ...
  case 8:
    if (identical) {
      if (player->craft_items[4] == 0) {
        ...
        switch (first_item) {
        case I_leather:
          *item = I_leather_chestplate;
          *count = 1;
          return;
        case I_iron_ingot:
          *item = I_iron_chestplate;
          *count = 1;
          return;
        case I_gold_ingot:
          *item = I_golden_chestplate;
          *count = 1;
          return;
        case I_diamond:
          *item = I_diamond_chestplate;
          *count = 1;
          return;
        case I_netherite_ingot:
          *item = I_netherite_chestplate;
          *count = 1;
          return;
        default:
          break;
...
#define registerSmeltingRecipe(a, b)                                           \
  if (*material == a && (*output_item == b || *output_item == 0))              \
  *output_item = b
...
void getSmeltingOutput(PlayerData *player) {
  ...
  if (*material_count == 0 || *fuel_count == 0)
    return;
  ...
  if (*fuel == I_coal)
    fuel_value = 8;
  else if (*fuel == I_charcoal)
    fuel_value = 8;
  else if (*fuel == I_coal_block)
    fuel_value = 80;
  else if (*fuel == I_oak_planks)
    fuel_value = 1 + (fast_rand() & 1);
  else if (*fuel == I_oak_log)
    fuel_value = 1 + (fast_rand() & 1);
  else if (*fuel == I_crafting_table)
    fuel_value = 1 + (fast_rand() & 1);
  else if (*fuel == I_stick)
    fuel_value = (fast_rand() & 1);
  else if (*fuel == I_oak_sapling)
    fuel_value = (fast_rand() & 1);
  else if (*fuel == I_wooden_axe)
    fuel_value = 1;
  else if (*fuel == I_wooden_pickaxe)
    fuel_value = 1;
  else if (*fuel == I_wooden_shovel)
    fuel_value = 1;
  else if (*fuel == I_wooden_sword)
    fuel_value = 1;
  else if (*fuel == I_wooden_hoe)
    fuel_value = 1;
  else
    return;

  uint8_t exchange =
      *material_count > fuel_value ? fuel_value : *material_count;
  ...
  *fuel_count -= 1;
  ...
  if (*material_count <= 0) {
    ...
    *material = 0;
    ...
    return getSmeltingOutput(player);
